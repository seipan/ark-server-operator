...
// ArkServerSpec defines the desired state of ArkServer
type ArkServerSpec struct {
	...
	// foo is an example field of ArkServer. Edit arkserver_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// ArkServerStatus defines the observed state of ArkServer.
type ArkServerStatus struct {
	...
	// conditions represent the current state of the ArkServer resource.
