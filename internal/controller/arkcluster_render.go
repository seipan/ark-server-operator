...
// ArkManagerCfgConfigMapName returns the ConfigMap name holding arkmanager.cfg.
func ArkManagerCfgConfigMapName(c *arkv1.ArkCluster) string {
	return c.Name + "-arkmanager-cfg"
}

// GlobalGameIniConfigMapName returns the ConfigMap name holding GlobalGame.ini.
func GlobalGameIniConfigMapName(c *arkv1.ArkCluster) string {
	return c.Name + "-game-ini"
}

// GlobalGameUserSettingsConfigMapName returns the ConfigMap name holding
// GlobalGameUserSettings.ini.
func GlobalGameUserSettingsConfigMapName(c *arkv1.ArkCluster) string {
	return c.Name + "-game-user-settings-ini"
}

// PlayerListsConfigMapName returns the ConfigMap name holding the player lists.
